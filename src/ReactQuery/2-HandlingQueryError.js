...
const HandlingQueryError = () => {
    const { isLoading, isError, error, data } = useQuery("my-data", dataFetch)
    return (
        <div>
...
export default 2 - HandlingQueryError;
...
const {isLoading, isError, error, data} = useQuery("data",dataFetch)
